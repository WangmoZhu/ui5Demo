...
sap.ui.define([
	...
	return Controller.extend("ZTM.controller.BaseController", {
		...
		// 获取设置Tcode的值
		gettcode : function(v) {
			return this.getModel().getProperty("/appProperties/tcode");
		},
		settcode : function(v) {
			this.getModel().setProperty("/appProperties/tcode", v, false);
		},
