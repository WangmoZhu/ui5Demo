 ...
 * @param {object} [oExternalAppData.presentationVariant] Object containing the current ui state of the app which will be forwarded to the target component.
 ...
 * @param {object} [oExternalAppData.selectionVariant] Stringified JSON object, which will be forwarded to the target component.
 * 
 ...
 * 
 */
sap.ui.generic.app.navigation.service.NavigationHandler.navigate = function(sSemanticObject,sActionName,vNavigationParameters,oInnerAppData,fnOnError,oExternalAppData) {  };
 ...
 * @param {object} [oExternalAppData.selectionVariant] Object containing selectionVariant, which will be passed to the target screen
 * @param {object} [oExternalAppData.presentationVariant] Object containing the current ui presentationVariant of the app, which will be passed to the target screen
 ...
 * 
 */
sap.ui.generic.app.navigation.service.NavigationHandler.processBeforeSmartLinkPopoverOpens = function(oTableEventParameters,sSelectionVariant,mInnerAppData,oExternalAppData) { return new Object(); };
