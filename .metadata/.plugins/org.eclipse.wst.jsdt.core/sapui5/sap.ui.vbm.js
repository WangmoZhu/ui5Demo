 ...
 * 
 */
sap.ui.vbm.GeoMap.prototype.getAriaLabel = function() { return ""; };
 ...
 * 
 */
sap.ui.vbm.GeoMap.prototype.setAriaLabel = function(sAriaLabel) { return new sap.ui.vbm.GeoMap(); };
 ...
 * 
 */
sap.ui.vbm.PieItem.prototype.getColor = function() { return ""; };
 ...
 * 
 */
sap.ui.vbm.PieItem.prototype.setColor = function(sColor) { return new sap.ui.vbm.PieItem(); };
 ...
 * <li>{@link #getCameraHistoryLength cameraHistoryLength} : int (default: 0)</li>
 * <li>{@link #getCameraHistoryPos cameraHistoryPos} : int</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 * <li>{@link #event:cameraChange cameraChange} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
 * @param {object} oControlEvent.getParameters
 * @param {int} oControlEvent.getParameters.historyPos Current position in camera history
 * @param {int} oControlEvent.getParameters.historyLength Camera history length
 * @public
 * 
 */
sap.ui.vbm.Viewport.prototype.cameraChange = function(oControlEvent) {  };

/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:cameraChange cameraChange} event of this <code>sap.ui.vbm.Viewport</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.vbm.Viewport</code> itself.
 * 
 * This event is fired when camera positioning changed
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ui.vbm.Viewport</code> itself
 * 
 * @returns {sap.ui.vbm.Viewport} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
sap.ui.vbm.Viewport.prototype.attachCameraChange = function(oData,fnFunction,oListener) { return new sap.ui.vbm.Viewport(); };

/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:cameraChange cameraChange} event of this <code>sap.ui.vbm.Viewport</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ui.vbm.Viewport.prototype.detachCameraChange = function(fnFunction,oListener) { return new sap.ui.vbm.Viewport(); };
 ...
 * 
 * @param {object} [mParameters] Parameters to pass along with the event
 * @param {int} [mParameters.historyPos] Current position in camera history
 * @param {int} [mParameters.historyLength] Camera history length
 * 
 * @returns {sap.ui.vbm.Viewport} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 */
sap.ui.vbm.Viewport.prototype.fireCameraChange = function(mParameters) { return new sap.ui.vbm.Viewport(); };
 ...
 * 
 * Default value is <code>0</code>.
 * @returns {int} Value of property <code>cameraHistoryLength</code>
 * 
 * @public
 * 
 */
sap.ui.vbm.Viewport.prototype.getCameraHistoryLength = function() { return 0; };
 ...
 * 
 * @returns {int} Value of property <code>cameraHistoryPos</code>
 * 
 * @public
 * 
 */
sap.ui.vbm.Viewport.prototype.getCameraHistoryPos = function() { return 0; };
 ...
 * 
 * Default value is <code>0</code>.
 * @param {int} iCameraHistoryLength New value for property <code>cameraHistoryLength</code>
 * @returns {sap.ui.vbm.Viewport} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ui.vbm.Viewport.prototype.setCameraHistoryLength = function(iCameraHistoryLength) { return new sap.ui.vbm.Viewport(); };
 ...
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
 * 
 * @param {int} iCameraHistoryPos New value for property <code>cameraHistoryPos</code>
 * @returns {sap.ui.vbm.Viewport} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ui.vbm.Viewport.prototype.setCameraHistoryPos = function(iCameraHistoryPos) { return new sap.ui.vbm.Viewport(); };
